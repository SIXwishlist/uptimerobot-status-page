...
<html>
	<head>
		...
		<link rel="stylesheet" href="uptimerobot-status-page.css">
		...
		<script>jQl.loadjQ('https://cdn.jsdelivr.net/g/prefixfree,rem,jquery@2.2.4,jquery.equalize,jquery.downboy');</script>
		<script>
			$(function(){
				equalize('.js-equalize-group','.js-equalize-me');
				downBoy('.js-footer');
